              ...
              <div class="col-lg-6">
                ...
                <div class="p-5 my-md-4">
                  ...
                  <div class="row align-items-stretch mb-4">
                    ...
                    <div class="col-sm-5 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="pages/addCart.php?id=<?= $pro['id'] ?>">Add to cart</a></div>
          ...
          <div class="col-lg-6">
            ...
            <div class="row m-sm-0">
              ...
              <div class="col-sm-10 order-1 order-sm-2">
                <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block" href="img/product-detail-1.jpg" data-lightbox="product" title="Product item 1"><img class="img-fluid" src="admin/fun/product/image/<?= $pros[0]; ?>" alt="..."></a><a class="d-block" href="img/product-detail-2.jpg" data-lightbox="product" title="Product item 2"><img class="img-fluid" src="admin/fun/product/image/<?= $pros[1]; ?>" alt="..."></a><a class="d-block" href="img/product-detail-3.jpg" data-lightbox="product" title="Product item 3"><img class="img-fluid" src="admin/fun/product/image/<?= $pros[2]; ?>" alt="..."></a><a class="d-block" href="img/product-detail-4.jpg" data-lightbox="product" title="Product item 4"><img class="img-fluid" src="admin/fun/product/image/<?= $pros[3]; ?>" alt="..."></a></div>
              </div>
            </div>
          </div>
          <!-- PRODUCT DETAILS-->
          <div class="col-lg-6">
            ...
            <h1><?= $product['name'] ?></< /h1>
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ml-2" href="#"><?= $cat['name'] ?></< /a>
                </li>
